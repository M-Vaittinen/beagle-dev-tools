...
//			echo 'calling system("/savustin/bin/read-resistance.sh /'.$res[$i].'");'; 
			system("/savustin/bin/read-resistance.sh /savustin/tmp/".$res[$i]);
//			echo 'reading measured resistance: trim(file_get_contents("/savustin/tmp/'.$res[$i].'"));';
...
if ($ctr == 3) {
	...
	die('kalibroitu <a href="index.php">PÄÄSIVULLE</a></html>');
}
?>
