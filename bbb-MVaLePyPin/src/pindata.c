...
const struct pin_info p8_pins[] = {
	/* P8_03 - R9 - gpmc_ad6 - offset 0x818 - GPIO1[6]=38 */
	{"P8_03", "R9", "conf_gpmc_ad6", 0x818, 1, 6,
		{"gpmc_ad6", "gpmc_a8", NULL, NULL, "pr1_pru1_pru_r30_6",
			"pr1_pru1_pru_r31_6", NULL, "gpio1[6]"},
		NULL},

	/* P8_04 - T9 - gpmc_ad7 - offset 0x81C - GPIO1[7]=39 */
	{"P8_04", "T9", "conf_gpmc_ad7", 0x81C, 1, 7,
		{"gpmc_ad7", "gpmc_a10", NULL, NULL, "pr1_pru1_pru_r30_7",
			"pr1_pru1_pru_r31_7", NULL, "gpio1[7]"},
		NULL},

	/* P8_05 - R8 - gpmc_ad2 - offset 0x808 - GPIO1[2]=34 */
	{"P8_05", "R8", "conf_gpmc_ad2", 0x808, 1, 2,
		{"gpmc_ad2", "gpmc_a9", NULL, NULL, "pr1_pru1_pru_r30_4",
			"pr1_pru1_pru_r31_4", NULL, "gpio1[2]"},
		NULL},

	/* P8_06 - T8 - gpmc_ad3 - offset 0x80C - GPIO1[3]=35 */
	{"P8_06", "T8", "conf_gpmc_ad3", 0x80C, 1, 3,
		{"gpmc_ad3", "gpmc_a11", NULL, NULL, "pr1_pru1_pru_r30_5",
			"pr1_pru1_pru_r31_5", NULL, "gpio1[3]"},
		NULL},

	/* P8_07 - R7 - gpmc_advn_ale - offset 0x890 - GPIO2[2]=66 */
	{"P8_07", "R7", "conf_gpmc_advn_ale", 0x890, 2, 2,
		{"gpmc_advn_ale", "gpmc_a18", NULL, NULL, "pr1_pru1_pru_r30_2",
			"pr1_pru1_pru_r31_2", NULL, "gpio2[2]"},
		NULL},

	/* P8_08 - T7 - gpmc_oen_ren - offset 0x894 - GPIO2[3]=67 */
	{"P8_08", "T7", "conf_gpmc_oen_ren", 0x894, 2, 3,
		{"gpmc_oen_ren", "gpmc_a19", NULL, NULL, "pr1_pru1_pru_r30_3",
			"pr1_pru1_pru_r31_3", NULL, "gpio2[3]"},
		NULL},

	/* P8_09 - T6 - gpmc_be0n_cle - offset 0x89C - GPIO2[5]=69 */
	{"P8_09", "T6", "conf_gpmc_be0n_cle", 0x89C, 2, 5,
		{"gpmc_be0n_cle", "gpmc_a17", NULL, NULL, "pr1_pru1_pru_r30_0",
			"pr1_pru1_pru_r31_0", NULL, "gpio2[5]"},
		NULL},

	/* P8_10 - U6 - gpmc_wen - offset 0x898 - GPIO2[4]=68 */
	{"P8_10", "U6", "conf_gpmc_wen", 0x898, 2, 4,
		{"gpmc_wen", "gpmc_a15", NULL, NULL, "pr1_pru1_pru_r30_1",
			"pr1_pru1_pru_r31_1", NULL, "gpio2[4]"},
		NULL},

	/* P8_11 - R12 - gpmc_ad13 - offset 0x834 - GPIO1[13]=45 */
	{"P8_11", "R12", "conf_gpmc_ad13", 0x834, 1, 13,
		{"gpmc_ad13", "gpmc_a16", NULL, NULL, "pr1_pru0_pru_r30_15",
			"pr1_pru0_pru_r31_15", NULL, "gpio1[13]"},
		NULL},

	/* P8_12 - T12 - gpmc_ad12 - offset 0x830 - GPIO1[12]=44 */
	{"P8_12", "T12", "conf_gpmc_ad12", 0x830, 1, 12,
		{"gpmc_ad12", "gpmc_a14", NULL, NULL, "pr1_pru1_pru_r30_13",
			"pr1_pru1_pru_r31_13", NULL, "gpio1[12]"},
		NULL},
	...
	{"P8_14", "T11", "conf_gpmc_ad10", 0x828, 0, 26,
		{"gpmc_ad10", "gpmc_a13", NULL, "ehrpwm2_tripzone_in", NULL,
			NULL, NULL, "gpio0[26]"},
		NULL},
	...
	{"P8_15", "U13", "conf_gpmc_ad15", 0x83C, 1, 15,
		{"gpmc_ad15", "gpmc_a6", NULL, "eQEP2_strobe",
			"pr1_pru1_pru_r30_12", "pr1_pru1_pru_r31_12", NULL,
			"gpio1[15]"},
		NULL},
	...
	{"P8_28", "V5", "conf_lcd_pclk", 0x8E8, 2, 24,
		{"lcd_pclk", "gpmc_a10", "lcd_data19", NULL,
			"pr1_pru1_pru_r30_7", "pr1_pru1_pru_r31_7", NULL,
			"gpio2[24]"},
		NULL},
	...
	{"P8_29", "R5", "conf_lcd_hsync", 0x8E4, 2, 23,
		{"lcd_hsync", "gpmc_a9", "lcd_data22", NULL,
			"pr1_pru1_pru_r30_4", "pr1_pru1_pru_r31_4", NULL,
			"gpio2[23]"},
		NULL},

	/* P8_30 - R6 - lcd_ac_bias_en - offset 0x8EC - GPIO2[25]=89 */
	{"P8_30", "R6", "conf_lcd_ac_bias_en", 0x8EC, 2, 25,
		{"lcd_ac_bias_en", "gpmc_a11", "lcd_data21", NULL, NULL, NULL,
			NULL, "gpio2[25]"},
		NULL},
	...
	{"P8_37", "U1", "conf_lcd_data8", 0x8C0, 2, 14,
		{"lcd_data8", "gpmc_a6", "lcd_data16", "mmc2_dat7", "uart5_txd",
			NULL, NULL, "gpio2[14]"},
		NULL},

	/* P8_38 - U2 - lcd_data9 - offset 0x8C4 - GPIO2[15]=79 */
	{"P8_38", "U2", "conf_lcd_data9", 0x8C4, 2, 15,
		{"lcd_data9", "gpmc_a7", "lcd_data17", "mmc2_clk", "uart5_rxd",
			NULL, NULL, "gpio2[15]"},
		NULL},
	...
	{"P8_39", "T3", "conf_lcd_data6", 0x8B8, 2, 12,
		{"lcd_data6", "gpmc_a4", "lcd_data23", "mmc2_dat4",
			"pr1_pru1_pru_r30_5", "pr1_pru1_pru_r31_5", NULL,
			"gpio2[12]"},
		NULL},
	...
	{"P8_40", "T4", "conf_lcd_data7", 0x8BC, 2, 13,
		{"lcd_data7", "gpmc_a5", "gpmc_be1n", NULL,
			"pr1_pru1_pru_r30_2", "pr1_pru1_pru_r31_2", NULL,
			"gpio2[13]"},
		NULL},
	...
	{"P8_41", "T1", "conf_lcd_data4", 0x8B0, 2, 10,
		{"lcd_data4", "gpmc_a2", "mmc1_dat5", "mmc2_dat3",
			"pr1_pru1_pru_r30_3", "pr1_pru1_pru_r31_3", NULL,
			"gpio2[10]"},
		NULL},
	...
	{"P8_42", "T2", "conf_lcd_data5", 0x8B4, 2, 11,
		{"lcd_data5", "gpmc_a3", "mmc1_dat4", "mmc2_dat2",
			"pr1_pru1_pru_r30_0", "pr1_pru1_pru_r31_0", NULL,
			"gpio2[11]"},
		NULL},
...
const struct pin_info p9_pins[] = {
	...
	{"P9_12", "U18", "conf_gpmc_ben1", 0x878, 1, 28,
		{"gpmc_be1n", "mii2_col", "gpmc_csn6", "mmc2_dat3", "gpmc_dir",
			"pr1_uart0_txd", NULL, "gpio1[28]"},
		NULL},
	...
	{"P9_14", "U14", "conf_gpmc_a2", 0x848, 1, 18,
		{"gpmc_a2", "rgmii2_td3", NULL, "mmc2_dat1", "mmc1_sdcd",
			"pr1_uart0_rts_n", "ehrpwm1A_mux1", "gpio1[18]"},
		NULL},
	...
	{"P9_16", "T14", "conf_gpmc_a3", 0x84C, 1, 19,
		{"gpmc_a3", "mii2_txd2", "rgmii2_td2", "mmc2_dat2", "mmc2_sdcd",
			"pr1_uart0_cts_n", "ehrpwm1B_mux1", "gpio1[19]"},
		NULL},

	/* P9_17 - A16 - spi0_cs0 - offset 0x95C - GPIO0[5]=5 */
	{"P9_17", "A16", "conf_spi0_cs0", 0x95C, 0, 5,
		{"spi0_cs0", "mmc2_sdwp", "I2C1_SCL", "ehrpwm0_synci", NULL,
			"pr1_uart0_txd", NULL, "gpio0[5]"},
		NULL},
	...
	{"P9_19", "D17", "conf_uart1_rtsn", 0x97C, 0, 13,
		{"uart1_rtsn", "timer5", "dcan0_rx", "I2C2_SCL", NULL,
			"pr1_uart0_rts_n", NULL, "gpio0[13]"},
		NULL},

	/* P9_20 - D18 - uart1_ctsn - offset 0x978 - GPIO0[12]=12 */
	{"P9_20", "D18", "conf_uart1_ctsn", 0x978, 0, 12,
		{"uart1_ctsn", "timer6", "dcan0_tx", "I2C2_SDA", NULL,
			"pr1_uart0_cts_n", NULL, "gpio0[12]"},
		NULL},

	/* P9_21 - B17 - spi0_d0 - offset 0x954 - GPIO0[3]=3 */
	{"P9_21", "B17", "conf_spi0_d0", 0x954, 0, 3,
		{"spi0_d0", "uart2_txd", "I2C2_SCL", "ehrpwm0B", NULL,
			"pr1_uart0_rts_n", NULL, "gpio0[3]"},
		NULL},

	/* P9_22 - A17 - spi0_sclk - offset 0x950 - GPIO0[2]=2 */
	{"P9_22", "A17", "conf_spi0_sclk", 0x950, 0, 2,
		{"spi0_sclk", "uart2_rxd", "I2C2_SDA", "ehrpwm0A", NULL,
			"pr1_uart0_cts_n", NULL, "gpio0[2]"},
		NULL},
	...
	{"P9_24", "D15", "conf_uart1_txd", 0x984, 0, 15,
		{"uart1_txd", "mmc2_sdwp", "dcan1_rx", "I2C1_SCL", NULL,
			"pr1_uart0_cts_n", NULL, "gpio0[15]"},
		NULL},
	...
	{"P9_25", "A14", "conf_mcasp0_ahclkx", 0x9AC, 3, 21,
		{"mcasp0_ahclkx", "eQEP0_strobe", "mcasp0_axr3", "mcasp1_axr1",
			NULL, "pr1_pru0_pru_r30_7", "pr1_pru0_pru_r31_7",
			"gpio3[21]"},
		"Also 24.576MHz HDMI audio clock input; disable oscillator "
		"before GPIO use"},

	/* P9_26 - D16 - uart1_rxd - offset 0x980 - GPIO0[14]=14 */
	{"P9_26", "D16", "conf_uart1_rxd", 0x980, 0, 14,
		{"uart1_rxd", "mmc1_sdwp", "dcan1_tx", "I2C1_SDA", NULL,
			"pr1_uart0_txd", NULL, "gpio0[14]"},
		NULL},

	/* P9_27 - C13 - mcasp0_fsr - offset 0x9A4 - GPIO3[19]=115 */
	{"P9_27", "C13", "conf_mcasp0_fsr", 0x9A4, 3, 19,
		{"mcasp0_fsr", "eQEP0B_in", "mcasp0_axr3", "mcasp1_fsx", NULL,
			"pr1_pru0_pru_r30_5", "pr1_pru0_pru_r31_5",
			"gpio3[19]"},
		NULL},
	...
	{"P9_31", "A13", "conf_mcasp0_aclkx", 0x990, 3, 14,
		{"mcasp0_aclkx", "ehrpwm0A", NULL, "spi1_sclk", NULL,
			"pr1_pru0_pru_r30_0", "pr1_pru0_pru_r31_0",
			"gpio3[14]"},
		NULL},
	...
	{"P9_41", "D14", "conf_xdma_event_intr1", 0x9B4, 0, 20,
		{"xdma_event_intr1", "eQEP0_index", "tclkin", "clkout2",
			"timer7_mux1", "pr1_pru0_pru_r30_6",
			"pr1_pru0_pru_r31_6", "gpio0[20]"},
		"Primary GPIO0[20]; GPIO3[20] also accessible via R221 (remove "
		"to disconnect)"},

	/* P9_42 - D13 - ecap0_in_pwm0_out - offset 0x964 - GPIO0[7]=7 */
	{"P9_42", "D13", "conf_ecap0_in_pwm0_out", 0x964, 0, 7,
		{"ecap0_in_pwm0_out", "uart3_txd", NULL,
			"pr1_ecap0_ecap_capin_apwm_o", "spi1_sclk", NULL,
			"pr1_pru0_pru_r30_4", "gpio0[7]"},
		"Primary GPIO0[7]; GPIO3[18] also accessible via R202 (remove "
		"to disconnect)"},
};
